...
; Howdy Hackers for Vectrex computer with 6809 CPU
...
; this header required to identify ROM by Vectrex hardware (only year allowed to change)
                ...
                db      "HOWDY HACKERS", $80      ; app title, ending with $80
                db      0                       ; end of header
...
; recalibrate CRT, reset beam to 0,0 (center of the screen)
                ...
                ldu     #howdyhackers             ; string address
                lda     #10                     ; Y
                ldb     #-45                    ; X
...
howdyhackers:     db      'HOWDY HACKERS!',$80
